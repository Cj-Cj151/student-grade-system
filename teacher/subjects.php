...
<div class="glass-card panel">
    <div class="panel-header">
        <h2 class="panel-title">Assigned Subjects</h2>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ((int) $s['pending_count'] > 0): ?>
                                    <span class="badge badge-pending"><?= (int) $s['pending_count'] ?> pending</span>
                                <?php else: ?>
                                    <span class="badge badge-passed">All encoded</span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <a href="/teacher/grades.php?subject_id=<?= (int) $s['subject_id'] ?>" class="btn btn-primary btn-sm">Manage Grades</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
